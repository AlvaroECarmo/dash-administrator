...
@section('content')
    @livewire('comuns.header', ['title'=>'Munzambi'])
    <div class="row">
        <!-- /.col -->
        <div class="col-md-12">
            ...
            <div class="card card-widget widget-user shadow">
                ...
                <div class="widget-user-header bg-info">
                    ...
                    @else
                        <h5 class="widget-user-desc">@if(Auth::user()->hasRole('Administrador')) Administrador @else
                                Técnico @endif</h5>
                    @endif
                </div>
                <div class="widget-user-image">
                    <img class="img-circle elevation-2" src="{{Auth::user()->getAvatarUrlAttribute()}}"
                         alt="User Avatar">
                </div>
