                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        <div class="col-xl-12 col-xxl-12 mb-xl-12 mb-xxl-12">
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="fs-2hx fw-bolder text-dark me-2 lh-1">Grupos de trabalho</span>
                                        ...
                                        <span
                                            class="text-gray-400 pt-1 fw-bold fs-6">Crie aqui um grupo de trabalho com permissões</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Header-->
                                ...
                                @livewire('forms.permissoes.new-group')
                                <!--end::forms-cabecalhos-->

                                @livewire('forms.permissoes.lista-group')
                            </div>
