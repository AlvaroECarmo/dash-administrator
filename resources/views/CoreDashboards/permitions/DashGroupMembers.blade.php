                ...
                <div id="kt_content_container" class="container-fluid">
                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        <div class="col-xl-12 col-xxl-12 mb-xl-12 mb-xxl-12">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="fs-2hx fw-bolder text-dark me-2 lh-1">Membros em Grupos</span>
                                        ...
                                        <span
                                            class="text-gray-400 pt-1 fw-bold fs-6">Gerir aqui os membros dos grupos criados</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Header-->
                            ...
                            @livewire('forms.permissoes.new-group-members')
                            @livewire('forms.permissoes.lista-group-members')
