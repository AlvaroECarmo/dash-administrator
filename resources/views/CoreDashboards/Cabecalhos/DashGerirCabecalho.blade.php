            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div id="kt_content_container" class="container-fluid">
                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        <div class="col-xl-12 col-xxl-12 mb-xl-12 mb-xxl-12">
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="fs-2hx fw-bolder text-dark me-2 lh-1">{{ config('ao.cabecalho.cabecalho.title') }}</span>
                                        ...
                                        <span
                                            class="text-gray-400 pt-1 fw-bold fs-6">{{  config('ao.cabecalho.cabecalho.context') }}</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Header-->
                                ...
                                @livewire('forms.cabecalho.forms-cabecalhos')
                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        @livewire('forms.cabecalho.lista-cabecalhos')
