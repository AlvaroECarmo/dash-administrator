                ...
                <div id="kt_content_container" class="container-fluid">
                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        <div class="col-xl-12 col-xxl-12 mb-xl-12 mb-xxl-12">
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <span
                                            class="text-gray-400 pt-1 fw-bold fs-6">Crie aqui um perfil adequado para o deputado</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Header-->
                            ...
                            @livewire('forms.blogs.blog-entidades.form-contexto')
                    ...
                    @livewire('forms.blogs.blog-entidades.lista-contexto')
