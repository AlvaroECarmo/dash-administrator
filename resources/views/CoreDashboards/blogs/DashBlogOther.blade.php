                ...
                <div id="kt_content_container" class="container-fluid">
                    ...
                    <div class="row g-5 g-xxl-10">
                        ...
                        <div class="col-xl-12 col-xxl-12 mb-xl-12 mb-xxl-12">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="fs-2hx fw-bolder text-dark me-2 lh-1">Edição de Paginas</span>
                            ...
                            @livewire('forms.blogs.blog-other.form-contexto')
                    ...
                    @livewire('forms.blogs.blog-other.lista-contexto')
