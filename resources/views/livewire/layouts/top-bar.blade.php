...
<div class="topbar">
    ...
    <div
        ...
        <div class="page-title d-flex flex-column me-5">
            <!--begin::Title-->
            <h1 class="d-flex flex-column text-dark fw-bolder fs-2 mb-0">Administrador</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">{{   Request::path()!= "/"?Request::path():"" }}</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="header-search me-4">
            ...
            <div id="kt_header_search" class="d-flex align-items-center w-lg-250px"
                ...
                <form data-kt-search-element="form"
                      class="d-none d-lg-block w-100 position-relative" autocomplete="off">
                    ...
                    <span
                        class="svg-icon svg-icon-3 search-icon position-absolute top-50 translate-middle-y ms-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                     viewBox="0 0 24 24" fill="none">
                                                    <path
                    ...
                    <!--end::Icon-->
                    <!--begin::Input-->
                    <input type="text" class="form-control bg-transparent ps-12" name="Procurar"
