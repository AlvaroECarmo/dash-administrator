...
<div class="form-group  mt-2 mb-3">
    <div class="" wire:ignore>
        <label class="required badge badge-light-info">{{ $entidadeParlamentar['note']}}
        </label>
...
@push('scripts')
    <script>
        ...
        element.addEventListener('change', (e) => {
            @this.
            set('data.context', e.target.value)
        })

        window.addEventListener('editorEditingMesaPresidio', evt => {
