<div>
    ...
    <div class="card-body p-lg-10">
        ...
        <div class="mb-15">
            <!--begin::Posts-->
            <div class="row g-10 border-left-1">
                @foreach($blogPagBody as $item)
                    <div class="col-md-12 ">
                        ...
                        <span class="badge badge-primary text-white "
                              ...
                              style="margin-top: -50px!important; margin-left: 18px; margin-bottom: 5px; cursor: pointer; ">
                                        ...
                                        @foreach($item->blogPageBody as $oe)
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content  text-gray-800 ps-3">
                                                    <p class="fw-bolder">{{ $oe->blogPagContentsId }}</p>
...
@push('scripts')
    <script>
        ...
        function selectoresInfo() {

            $('#selectGrupers').select2().on('change', (e) => {
                const eleTY = e.target.value

                @this.set('itemSelect', eleTY)
