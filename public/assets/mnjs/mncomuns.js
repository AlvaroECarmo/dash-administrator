...
function confirmSwit(_message = '', _icon = 'info') {
    return Swal.fire({
        html: _message,
        icon: _icon,
...
window.imageBack = {
    init: function (image = '', defaultImage = '', elementDocument) {
        $(elementDocument).css("background-image", "url(" + defaultImage + ")");
        if (image != '') {
            $(elementDocument).css("background-image", "url(" + image + ")");
        }
    }
}
window.imageBackConfig = {
    init: function (image = '', defaultImage = '', elementDocument) {
        $(elementDocument).css("background-image", "url(" + defaultImage + ")");
        if (image != '') {
            $(elementDocument).css("background-image", "url(" + image + ")");
...
window.addEventListener('activeFunctionality', function () {
    !function (e, t) {
        ...
        return function (e) {
            ...
            function V(e) {
                var t = this, n = e.core, o = n.eventsDispatcher, i = n.fullscreenToggler,
                    ...
                    s = n.scrollbarRecompensor, a = e.data, c = e.elements, u = e.props,
            ...
            function Y(e) {
                var t, n = e.props.sources, o = e.resolve, i = e.slideSwipingProps, r = o(_),
                    s = (t = !1, function () {
            ...
            function Q(e) {
                ...
                n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
                    ...
                    var t, n, o = e.collections.sourceMainWrappersTransformers, i = e.componentsServices,
                        r = e.core,
                        s = r.classFacade, a = r.slideIndexChanger, c = r.sourceDisplayFacade,
                        l = r.stageManager,
                    ...
                    var t = e.collections, n = t.sourceMainWrappersTransformers, o = t.sourceSizers,
                        i = e.core.windowResizeActioner, r = e.data, s = e.elements.sourceMainWrappers,
                        a = e.props,
                        c = e.stageIndexes;
            ...
            function ee(e) {
                var t = e.collections.sourceMainWrappersTransformers, n = e.componentsServices, o = e.core,
                    ...
                    c = o.sourceDisplayFacade, u = o.stageManager, d = o.windowResizeActioner, p = e.data,
                    f = e.elements,
                    h = e.stageIndexes;
                r.open = function () {
...
window.addEventListener('imageFuncionality',
    function () {
    !function (e, t) {
        if ("object" == typeof exports && "object" == typeof module) module.exports = t(); else if ("function" == typeof define && define.amd) define([], t); else {
            var n = t();
